...
admin.site.site_header = "JCA"
admin.site.site_title = "JCA Admin Portal"
admin.site.index_title = "JCA Admin"

# swagger
api_info = openapi.Info(
    title="JCA API",
    default_version="v1",
    description="API documentation for JCA App",
)
